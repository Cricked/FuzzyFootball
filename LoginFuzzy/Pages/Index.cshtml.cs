...
namespace LoginFuzzy.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(ILogger<IndexModel> logger, UserManager<ApplicationUser> futbolista, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager)
        {
            _logger = logger;
